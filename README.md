...
Hyde-Forked is a brazen two-column [hugo](https://gohugo.io) theme based on the [Jekyll](http://jekyllrb.com) theme of the same name.
...
To install Hyde as your default theme, first install this repository in the `themes/` directory:
    ...
    $ cd themes/
    $ git clone https://github.com/nmarley/hugo-theme-hyde-forked.git

Second, specify `hyde` as your default theme in the `config.toml` file. Just add the line

    theme = "hugo-theme-hyde-forked"
